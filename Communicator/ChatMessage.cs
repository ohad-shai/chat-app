...
namespace Communicator
{
    ...
    public sealed class ChatMessage
    {
        ...
        public ChatMessage(User sender, string sendTo, string text, MessageType type)
        ...
        public ChatMessage(User sender, string sendTo, string text, MessageType type, Image image)
        {
            Sender = sender;
            SendTo = sendTo;
            SentAt = DateTime.Now;
