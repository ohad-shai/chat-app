...
namespace Server_GUI
{
    public partial class MainForm : Form
    {
        ...
        private void ServerEventsRegistration()
        {
            ...
            server.UserDisconnected += new Action<User>(form_UserDisconnected);
        ...
        private void form_UserDisconnected(User user)
        {
            if (InvokeRequired)
            {
                Invoke(new Action<User>(form_UserDisconnected), user);
                return;
            }
